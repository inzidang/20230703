...
export default function Footer() {
  return <div className="w-full flex h-footer-height justify-center pt-8 px-2">
    <div className="w-full h-full px-layout-padding">
      <div className="grid grid-cols-5 h-full">
        ...
        <div className=" relative col-span-2 w-full flex flex-col items-start space-y-2">
          ...
          {/* 4-2 */}
          <div className="w-[75%]">
            <h2 className="">대구오페라하우스는 공직자윤리법 제3조의2에 따른 공직유관단체로서 부정청탁 및 금품 등 수수의 금지에 관한 법률(청탁금지법) 적용대상 기관임을 알립니다.</h2>
          ...
          <div className="w-full absolute bottom-0 flex justify-end items-center space-x-4">
            ...
            <div className="w-16 h-16 bg-neutral-800 text-white flex justify-center items-center animate-ping">
              <AiOutlineArrowUp size="20" /></div>
          </div>
        </div>
      </div>
    </div>
